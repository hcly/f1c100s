...
# define CONFIG_ENV_SPI_BUS	CONFIG_SF_DEFAULT_BUS // 0
#endif
#ifndef CONFIG_ENV_SPI_CS
# define CONFIG_ENV_SPI_CS	CONFIG_SF_DEFAULT_BUS // 0
#endif
#ifndef CONFIG_ENV_SPI_MAX_HZ
# define CONFIG_ENV_SPI_MAX_HZ	CONFIG_SF_DEFAULT_SPEED // 100000000
#endif
#ifndef CONFIG_ENV_SPI_MODE
# define CONFIG_ENV_SPI_MODE	CONFIG_SF_DEFAULT_MODE // SPI_MODE_3
#endif
...
char *spinand_env_name_spec = "SPI Flash";
...
int spinand_env_relocate_spec(void)
{
	int ret;
	char *buf = NULL;
...
U_BOOT_ENV_LOCATION(sf) = {
	...
	ENV_NAME("SPI Flash")
	.load		= spinand_env_relocate_spec,
// #ifdef CMD_SAVEENV
	.save		= env_save_ptr(spinand_saveenv),
// #endif
};
