...
#define SPI_NAND_GD5F_ECC_MASK		0x30
#define SPI_NAND_GD5F_ECC_0_BIT		0x0
#define SPI_NAND_GD5F_ECC_1_7_BIT	0x10
#define SPI_NAND_GD5F_ECC_UNCORR	0x20
#define SPI_NAND_GD5F_ECC_8_BIT		0x30
typedef enum {
        WRAP2112B = 0x0 ,
        WRAP2048B = 0x4 ,
        WRAP64B = 0x8 ,
...
#define SPINAND_USED_GIGADEVICE	(1 << 2)
...
int spi_nand_read_oob(struct spi_nand_chip *chip, loff_t from, struct mtd_oob_ops *ops);
int spi_nand_write_oob(struct spi_nand_chip *chip, loff_t to, struct mtd_oob_ops *ops);
